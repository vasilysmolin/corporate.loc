    ...
    <div class="widget-first widget recent-posts">
        <h3>{{ Lang::get('ru.latest_progects') }}</h3>
                ...
                @foreach($portfolios as $portfolio)
                    ...
                    <div class="hentry-post group">
                        ...
                        <div class="text">
                            ...
                            <a class="read-more" href="{{ route('portfolios.show', ['alias'=>$portfolio->alias]) }}">&rarr; Lang::{{ Lang::get('ru.read_more') }}</a>
                        </div>
                    </div>
        ...
        <div class="recent-post recent-comments group">
            @if(!$comments->isEmpty())
                ...
                <div class="the-post group">
                    ...
                    <a class="title" href="{{ route('articles.show', ['alias'=>$comment->article->alias]) }}">{{ $comment->title }}</a>
                    <p class="comment">
