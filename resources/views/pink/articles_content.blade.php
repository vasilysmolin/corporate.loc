            ...
            <div class="sticky hentry hentry-post blog-big group">
                ...
                <div class="thumbnail">
                    ...
                    <div class="image-wrap">
                        <img src="{{ asset(env('THEME')) }}/images/articles/{{ $article->img->path }}" alt="001" title="001" />
                    </div>
                    <p class="date">
                ...
                <div class="meta group">
                    <p class="author"><span>by <a href="#" title="Posts by {{ $article->user->name }}" rel="author">Nicola Mustone</a></span></p>
